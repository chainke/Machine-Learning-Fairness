...
class DataGen:
    ...
    def print_dist_glvq(self, X, Y, C):
        ...
        # non-white: do not pay
        ax.scatter(X[log00_neg, 0], X[log00_neg, 1], c=tango_color(color_0, 0),
                   edgecolors=tango_color(color_0, 2), marker='o')
        # non-white: pay
        ax.scatter(X[log01_neg, 0], X[log01_neg, 1], c=tango_color(color_0, 0),
                   edgecolors=tango_color(color_0, 2), marker='o')
        # white: do not pay
        ax.scatter(X[log10_neg, 0], X[log10_neg, 1], c=tango_color(color_1, 0),
                   edgecolors=tango_color(color_1, 2), marker='s')
        # white: pay
        ax.scatter(X[log11_neg, 0], X[log11_neg, 1], c=tango_color(color_1, 0),
                   edgecolors=tango_color(color_1, 2), marker='s')

        # non-white: do not pay
        ax.scatter(X[log00_pos, 0], X[log00_pos, 1], c=tango_color(color_pos, 0),
                   edgecolors=tango_color(color_0, 2), marker='o')
        # non-white: pay
        ax.scatter(X[log01_pos, 0], X[log01_pos, 1], c=tango_color(color_pos, 0),
                   edgecolors=tango_color(color_0, 2), marker='o')
        # white: do not pay
        ax.scatter(X[log10_pos, 0], X[log10_pos, 1], c=tango_color(color_pos, 0),
                   edgecolors=tango_color(color_1, 2), marker='s')
        # white: pay
        ax.scatter(X[log11_pos, 0], X[log11_pos, 1], c=tango_color(color_pos, 0),
                   edgecolors=tango_color(color_1, 2), marker='s')
        plt.show()
        return
